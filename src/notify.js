 ...
 * @returns {Promise}
 */
function main(projectId, key, image, sshKeys, path, deployment, host) {
  ...
  return post(data, key, path, clusternatorHost);
}
...
function post(data, auth, path, clusternatorHost) {
  ...
  console.log('Posting To:', clusternatorHost);
